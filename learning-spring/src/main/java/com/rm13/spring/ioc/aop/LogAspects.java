...
public class LogAspects {
     ...
     * 2、其他的切面引用
     */
    @Pointcut("execution(* com.rm13.spring.ioc.aop.MathCalculator.*(..)))")
     ...
     * @param joinPoint
     */
    @After("com.rm13.spring.ioc.aop.LogAspects.pointCut()")
     ...
     * @param result
     */
    @AfterReturning(value = "com.rm13.spring.ioc.aop.LogAspects.pointCut()", returning = "result")
