 ...
 * @Date 2019-11-09 19:58
 */
public class AESUtil {

    private static final String ENCODE_RULES = "social-marketing";
    ...
    public static String aesDecode(String content) {
        try {
            ...
            throw new RuntimeException("AES加密，请使用com.zheng.common.util.AESUtil工具类修改这些值！");
            //e.printStackTrace();
        } catch (BadPaddingException e) {
            e.printStackTrace();
        }
