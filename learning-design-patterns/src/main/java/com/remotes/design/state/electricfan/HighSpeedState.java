...
public class HighSpeedState implements IState {
    ...
    public void lowSpeed(ElectricFanMachine electricFanMachine) {
        ...
        System.out.println("当前状态：HighSpeed，状态改变：lowSpeed, 当前风速：" + electricFanMachine.getWindSpeed());
    }
    ...
    public void mediumSpeed(ElectricFanMachine electricFanMachine) {
        ...
        System.out.println("当前状态：HighSpeed，状态改变：mediumSpeed, 当前风速：" + electricFanMachine.getWindSpeed());
    }
    ...
    public void highSpeed(ElectricFanMachine electricFanMachine) {
        ...
        System.out.println("当前状态：HighSpeed，状态改变：highSpeed, 当前风速：" + electricFanMachine.getWindSpeed());
    }
    ...
    public void turningOff(ElectricFanMachine electricFanMachine) {
        ...
        System.out.println("当前状态：HighSpeed，状态改变：turningOff, 当前风速：" + electricFanMachine.getWindSpeed());
    }

    @Override
    public String getName() {
        return StateEnum.HIGH_SPEED.getDesc();
    }
}
